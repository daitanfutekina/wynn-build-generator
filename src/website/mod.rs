...
use crate::{item_from_tt, make_build, wynn_data::{atree::AtreeBuild, builder::WynnBuild, items::{self, Type, WynnItem, Atrs}, unhash_to_vec, unhash_val, url_hash_val, Class}, WynnEnum};
...
const STAT_RENAMES: &'static [&'static str; Atrs::NUM_STATS-Atrs::NUM_ELE_STATS+CalcStat::NUM_VARIENTS] = &["Melee Single Hit","Melee Dps","Base Spell Damage","Spell 1 Damage","Spell 2 Damage","Spell 3 Damage","Spell 4 Damage","Spell 1 / sec","Spell 2 / sec","Spell 3 / sec","Spell 4 / sec","Effective Mana Regen","Effective HP", "Effective HP Regen", "Health", "Earth Def", "Thunder Def", "Water Def", "Fire Def","Air Def","Damage Mult", "Defence Mult","Attack Spd", "Crit Damage %", "Damage %", "Damage Raw", "Stealing", "Exploding", "Heal %", "Health Bonus", "Health Regen %", "Health Regen Raw", "Jump Height", "Knockback", "Loot Bonus", "Life Steal", "Main Attack Range", "Max Mana", "Melee Dam %", "Melee Dam Raw", "Mana Regen", "Mana Steal", "Poison", "Reflection", "Spell Damage %", "Spell Damage Raw", "Slow Enemy", "Spell 1 Cost %", "Spell 2 Cost %", "Spell 3 Cost %", "Spell 4 Cost %", "Spell 1 Cost Raw", "Spell 2 Cost Raw", "Spell 3 Cost Raw", "Spell 4 Cost Raw", "Speed", "Sprint", "Sprint Regen", "Thorns", "Weaken Enemy", "XP Bonus"];
const STAT_COLOR_CLASSES: &'static [&'static str; Atrs::NUM_STATS-Atrs::NUM_ELE_STATS+CalcStat::NUM_VARIENTS] = &["str","str","int","int","int","int","int","int","int","int","int","int","def","def","def", "str", "dex", "int", "def", "agi", "neut", "def", "dex", "dex", "neut", "neut", "neut", "def", "def", "def", "def", "agi", "agi", "neut", "def", "str", "int", "str", "str", "int", "int", "neut", "neut", "int", "int", "neut", "int", "int", "int", "int", "int", "int", "int", "int", "neut", "agi", "agi", "agi", "neut", "neut", "neut"];
